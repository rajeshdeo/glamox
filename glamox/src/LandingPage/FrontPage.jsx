    ...
    <div className="front_page_container">
      ...
      <div className="biggest_day_container">
        ...
        <div >
          ...
          />
          <h4>Up To 20% Off</h4>
          <h4 className="greycolor">On Entire Range</h4>
        </div>
        <div >
          <img className="biggest_day_divs"
          ...
          />
          <h4>Up To 25 % Off</h4>
          <h4 className="greycolor">Great Deals On Combos</h4>
        </div>
        <div>
          <img className="biggest_day_divs"
          ...
          />
          <h4>Up To 10% Off</h4>
          <h4 className="greycolor">On Entire Branch</h4>
        </div >
      </div>
      ...
      <div className="sale_ary_saver_container">
        ...
        <div>
          ...
          />
          <h3>Up To 20% Off</h3>
          <h3 className="greycolor">On Liquid Lipsticks & Tints</h3>
        </div>
        <div>
          <img
        ...
        <div>
          ...
          />
          <h3>Up To 25% Off</h3>
          <h3 className="greycolor">Flat 50% OFF On Super Serums</h3>
        </div>
      </div>
